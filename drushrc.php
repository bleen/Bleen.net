...
// Include our default, environmnet specific settings file because it contains
// aglobal $env variable that identifiesour current environemnt.
@include('../settings.bleen.php');
...
// This will work no matter which environment your in.
//$options['alias-path'][] = getcwd() . '/sites';
//$options['alias-path'][] = '~/.drush';
